...
namespace App.Shared.GameModules.Player.Appearance
{
    public class AppearanceManager : ICharacterAppearance
    {
        ...
        {
            _wardrobeController.SetP1WardrobeTopLayerShader();
            _weaponController.SetP1WeaponTopLayerShader();
        }

        public void ResetP1ObjShader()
        {
            _wardrobeController.ResetP1WardrobeShader();
            _weaponController.ResetP1WeaponShader();
        }
