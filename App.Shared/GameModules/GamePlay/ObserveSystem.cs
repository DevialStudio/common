...
namespace App.Shared.GameModules.GamePlay
{
    public class ObserveSystem : AbstractGamePlaySystem<PlayerEntity>
    {
        ...
        private void UpdateValue(PlayerEntity player)
        {
            ...
            observedPlayer.observeCamera.CameraPosition = observedPlayer.appearanceInterface.Appearance.IsFirstPerson
                ? observedPlayer.thirdPersonDataForObserving.ThirdPersonArchorPosition
                : observedPlayer.cameraFinalOutputNew.Position;
            ...
            observedPlayer.observeCamera.IsFirstAppearance = observedPlayer.appearanceInterface.Appearance.IsFirstPerson;
