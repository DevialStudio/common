...
{
    /// <summary>
    /// Defines the <see cref="GrenadeCacheHelper" />
    /// </summary>
    public class GrenadeCacheHelper : IGrenadeCacheHelper
    {
        private static readonly LoggerAdapter Logger = new LoggerAdapter(typeof(GrenadeCacheHelper));

        private Dictionary<int, int> heldGrenades;
        public Dictionary<int,int> HeldGrenades { get { return heldGrenades; } }
     ...
     //   , Func<WeaponEntity> grenadeEntiyExtractor
        public GrenadeCacheHelper(Func<GrenadeCacheDataComponent> extractor, Func<WeaponEntity> in_grenadeEntiyExtractor, List<int> grenadeIds,IFreeArgs freeArgs)
        {
        ...
        public void SetCurr(int curr)
        {
            ...
            GetGrenadeEntity().weaponBasicData.ConfigId = curr;
        }
        ...
        public int LastGrenadeId { get { return GrandeCache.LastId; } }
