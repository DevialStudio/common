...
namespace App.Shared
{
    ...
    public interface IPlayerWeaponSharedGetter : IGameWeapon
    {
        ...
        /// <param name="slot"></param>
        /// <returns></returns>
        bool IsHeldBagSlotType(EWeaponSlotType slot, int bagIndex = -1);
        /// <summary>
        /// 轮询获取上一把武器配置id
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns></returns>
        WeaponBaseAgent GetWeaponAgent(EWeaponSlotType slotType = EWeaponSlotType.Pointer, int bagIndex = -1);

        IGrenadeCacheHelper GrenadeHelper { get; }

        bool IsWeaponInSlot(int configId,int bagIndex=-1);
